module.exports = {
  launch: () =>
    `You can ask for the latest air quality data for your location, like so: "Alexa, ask Air Quality for the latest". You can also ask by providing a specific location, like so: "Alexa, ask Air Quality for the latest in Liverpool". If you need more details on the air quality index, ask: "Alexa, ask Air Quality what the air quality index scale is".`,
  ...
  help: () =>
    `This Alexa skill provides Defra air quality data for locations around the UK using the air quality index scale. You can ask for the latest air quality data for your location, like so: "Alexa, ask Air Quality for the latest". You can also ask by providing a specific location, like so: "Alexa, ask Air Quality for the latest in Liverpool". If the skill finds multiple stations in the location you provide, it will list them after giving a response, allowing you to ask for the air quality at a more specific location. If you need more details on the air quality index, ask: "Alexa ask Air Quality what the air quality index scale is". So, how can I help?`,

  unknownIntent: () =>
    `I'm sorry, I didn't understand that. You can ask for the latest air quality data for your location, like so: "Alexa, ask Air Quality for the latest". You can also ask by providing a specific location, like so: "Alexa, ask Air Quality for the latest in Liverpool". If you need more details on the air quality index, ask: "Alexa ask Air Quality what the air quality index scale is".`,
